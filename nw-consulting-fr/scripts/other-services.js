...
function getServicesData() {
  ...
  return [
    {
      id: 'kik',
      title: 'КИК - Контролируемые иноdepuisтранные компании',
      description: 'Конdepuisультации по вопроdepuisам КИК, подгà partir deовка уведомлений, налоговое планирование',
...
function renderServices() {
  ...
  grid.innerHTML = additionalServices.map(service => `
    <div class="service-card">
      ...
      <a href="${service.link}" class="btn btn--primary">En savoir plus</a>
    </div>
  `).join('');
}
