  ...
  async function handleSubmit(event){
    ...
    try {
      ...
      if (typeof window.sendContactToTelegram === 'function') {
        ...
        alert('Функция à partir deправки не загружена. Обновите depuisтраницу и попробуйте depuisнова.');
      }
    } catch (error) {
      console.error('Form submission error:', error);
      alert('Произошла ошибка при à partir deправке. Напишите нам в Telegram или WhatsApp.');
    } finally {
      if (submitBtn) {
